        ...
        <div>        
          ...
          <div className="starholder">
              <form id={`stars${props.postId}`}>
                <label htmlFor={`star-1${props.postId}`}><FaStar /></label>
                ...
                <label htmlFor={`star-2${props.postId}`}><FaStar /></label>
                ...
                <label htmlFor={`star-3${props.postId}`}><FaStar /></label>
                ...
                <label htmlFor={`star-4${props.postId}`}><FaStar /></label>
                ...
                <label htmlFor={`star-5${props.postId}`}><FaStar /></label>
